...
const News = ({ title }) => {
  return (
    <div>
      <div className="px-[20px] py-[60px] xl:px-[190px]  flex justify-between ">
        <h2
          className="font-bold 
        text-[48px] leading-[50px] lg:text-[72px] 
        2xl:text-[96px] lg:leading-[74px] 2xl:leading-[110px] text-black pl-[25px] md:pl-0"
        >
          Karma news <br />
          and cases
        </h2>
